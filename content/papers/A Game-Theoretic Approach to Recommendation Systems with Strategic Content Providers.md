...
多利益相关者推荐中，平台不仅面对用户，也面对争夺曝光的内容提供者，内容提供者知道推荐规则后，会选择让自己更容易被展示的内容. 如果机制只追求当前相关性，可能导致 provider 之间反复调整内容，系统没有稳定状态。能否设计一个 mediator，使它对内容提供者公平，并且在任意推荐博弈中都存在纯策略 Nash 均衡？
## 记号约定
